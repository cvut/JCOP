...
/**
 * Tests proper behavior of {@link FillOperation} in {@link Bucket} problem.
 *
...
public class FillOperationTest {
    ...
    public void testExecute() throws Exception {
        ...
        Configuration c2 = new FillOperation(bucket.buckets.get(0)).execute(c);

        assert c2.valueAt(0) == 6 : "Expected configuration variable 6, " + c2.valueAt(0) + " found";
        ...
        c2 = new FillOperation(bucket.buckets.get(1)).execute(c);
        ...
        c2 = new FillOperation(bucket.buckets.get(2)).execute(c);
